        ...
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="tel:+78001012009" className="btn-outline-white inline-flex items-center gap-2 justify-center">
      ...
      <section className="py-12 bg-[#B91C1C] text-white">
        <div className="container max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="tel:+78001012009" className="border-2 border-white text-white font-heading font-bold px-6 py-3 rounded-full hover:bg-white/10 transition inline-flex items-center gap-2 justify-center">
              <Phone size={16} /> 8(800)101-2009
            </a>
          </div>
        </div>
