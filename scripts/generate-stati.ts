...
const TOPICS = [
  ...
  {
    slug: "montazh-ventilyacii-v-kafe",
    category: "Вентиляция",
    keywords: "вентиляция в кафе, вытяжка в кафе, жироуловитель, кухонная вентиляция, монтаж вентиляции в ресторане",
    prompt: "Напиши SEO-статью для freonn.ru: 'Монтаж вентиляции в кафе и ресторане: нормы, расчёт и жироулавливание'. Целевая аудитория — владельцы кафе, ресторанов и общепита. Раскрой: воздухообмен по СП и СанПиН, жироуловители, схемы вытяжки/притока, шум, этапы монтажа, обслуживание.",
  },
  {
    slug: "otoplenie-sklada",
    category: "Отопление",
    keywords: "отопление склада, воздушное отопление склад, тепловые завесы склад, инфракрасное отопление склада",
    prompt: "Напиши SEO-статью для freonn.ru: 'Отопление склада: расчёт, системы и монтаж'. Целевая аудитория — владельцы складских и логистических комплексов. Раскрой: водяное vs воздушное vs инфракрасное, теплопотери, расчёт мощности, тепловые завесы, энергоэффективность, этапы монтажа.",
  },
  {
    slug: "vodosnabzhenie-magazina",
    category: "Водоснабжение",
    keywords: "водоснабжение магазина, канализация магазина, проектирование водопровода, монтаж водоснабжения в торговом центре",
    prompt: "Напиши SEO-статью для freonn.ru: 'Водоснабжение и канализация магазина: проектирование и монтаж'. Целевая аудитория — арендодатели и владельцы торговых площадей. Раскрой: нормы потребления воды, разводка в ТЦ, материалы, узел учёта, требования к сантехнике, этапы монтажа.",
  },
  {
    slug: "elektrosnabzhenie-ofisa",
    category: "Электроснабжение",
    keywords: "электроснабжение офиса, проектирование электрики в офисе, распределительный щит офис, освещение офиса",
    prompt: "Напиши SEO-статью для freonn.ru: 'Электроснабжение офиса: проектирование, монтаж и освещение'. Целевая аудитория — офисные центры и бизнес-центры. Раскрой: расчёт нагрузок, вводно-распределительные устройства, группы освещения и розетки, СКС, требования ПУЭ и СНиП, этапы монтажа.",
  },
  {
    slug: "kondicionirovanie-kottedzha",
    category: "Кондиционирование",
    keywords: "кондиционирование коттеджа, мульти сплит система, vrf в частном доме, montazh kondicionera v kottedzhe",
    prompt: "Напиши SEO-статью для freonn.ru: 'Кондиционирование коттеджа и частного дома: расчёт и выбор системы'. Целевая аудитория — владельцы коттеджей и загородных домов. Раскрой: сплит vs мульти-сплит vs VRF, расчёт теплопритоков, зонирование, скрытый монтаж, шум, обслуживание.",
  },
];
