...
const STATIC_PAGE_SEO: Record<string, PageSeoMeta> = {
  ...
  "/otzyvy": {
    ...
    description:
      "Оставьте отзыв о работе Freonn. Реальные отзывы клиентов о монтаже вентиляции, кондиционирования, дымоудаления и отопления в Москве и МО.",
...
const PRICING_SERVICE_META: Record<string, PageSeoMeta> = {
  ...
  kompleks: {
    title: "Цены на комплексный монтаж инженерных систем — Freonn",
    description:
      "Комплексный монтаж вентиляции, кондиционирования, отопления, водоснабжения, дымоудаления и электроснабжения. Расчёт стоимости под ключ, скидка до 15% при заказе нескольких систем.",
    keywords:
      "цены комплексный монтаж, стоимость инженерных систем, прайс монтаж под ключ",
  },
  montazh: {
    title: "Цены на монтажные работы по инженерным системам — Freonn",
    description:
      "Стоимость монтажных работ по вентиляции, кондиционированию, отоплению, водоснабжению, дымоудалению и электроснабжению. Работаем по проектам заказчика, гарантия до 3 лет.",
    keywords:
      "цены монтажные работы, стоимость монтажа инженерных систем, расценки монтаж",
  },
  "kompleksnaya-realizaciya": {
    title: "Цены на комплексную реализацию инженерных систем под ключ — Freonn",
    description:
      "Комплексная реализация инженерных систем под ключ: от проектирования и поставки оборудования до монтажа, пусконаладки и сдачи объекта. Скидка до 15%.",
    keywords:
      "цены комплексная реализация, стоимость инженерных систем под ключ, проектирование и монтаж",
  },
};
